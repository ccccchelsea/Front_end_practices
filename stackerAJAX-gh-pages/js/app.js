...
var showAnswerer = function(answerer){
	...
	img.attr('src', answerer.user.profile_image);
	
	// Set the answerer properties in result
	var answererElem = result.find('a');
	answererElem.attr('href', answerer.user.link);

	// Set user_name
	var user_name = result.find('h3');
	user_name.text(answerer.user.display_name);
...
var getInspiration = function(topic) {
	...
	var url_answerers = "http://api.stackexchange.com/2.2/tags/" + topic 
						+ "/top-answerers/"+ request.period; 
